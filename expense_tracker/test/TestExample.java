...
public class TestExample {
        ...
        public void checkTotalCostInView(double totalCost) {
                ...
                double totalCostInView = Double
                                .parseDouble(viewModel.getValueAt(viewModel.getRowCount() - 1, 3).toString());
        ...
        @Test
        public void testObserverPatternWithActualNumbers() {
                ...
                // Add a transaction
                Transaction transaction = new Transaction(100, "Food"); // Assume Transaction is a valid class
